...
#define RPL_LIST(source, channel, userCount, topic) "322 " + source + " " + channel + " " + std::to_string(userCount) + " :" + topic
...
#define RPL_TOPICWHOTIME(source, channel, nick, time) "333 " + source + " " + channel + " " + nick + " " + time
